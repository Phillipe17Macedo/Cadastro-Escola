...
func main() {
    ...
    r.Use(cors.New(cors.Config{
        AllowOrigins:     []string{"https://66d24818e48ede00083ac55e-cadastro-escola-frontend.netlify.app", "http://localhost:3000", "https://cadastro-escola-production.up.railway.app"},

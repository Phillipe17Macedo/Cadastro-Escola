...
func main() {
    ...
    r.Use(cors.New(cors.Config{
        AllowOrigins:     []string{"https://66d242496274265ddcaf05af--cadastro-escola-frontend.netlify.app", "http://localhost:3000", "https://cadastro-escola-production.up.railway.app"},

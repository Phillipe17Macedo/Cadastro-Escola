...
func main() {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://66d252c334fd8700085d3d6a--cadastro-escola-frontend.netlify.app", "http://localhost:3000", "https://cadastro-escola-production.up.railway.app"},
